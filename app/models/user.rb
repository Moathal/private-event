...
class User < ApplicationRecord
  ...
  has_many :attendances, class_name: 'Attendance', foreign_key: 'attendee_id', dependent: :destroy
  has_many :attended_events, through: :attendances, source: :event

  has_many :events_as_host, class_name: 'Attendance', foreign_key: 'host_id'
  has_many :hosted_events, through: :events_as_host, source: :event, dependent: :destroy
