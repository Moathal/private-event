...
# a AUTOGENERATED BY NOTICED GEM  its to add notifications and broadcast any commit to the user.
class Notification < ApplicationRecord
  ...
  after_update_commit do
    broadcast_replace_later_to([recipient, 'notifications'],
                               ...
                               locals: { notifications: returned_notifications(recipient),
                                         unread_count: unread(recipient).count, read_count: read(recipient).count },
                               target: 'notifications')
    broadcast_replace_later_to([recipient, 'notificationsCount'],
                               partial: 'layouts/count',
                               locals: { unread_count: unread(recipient).count },
