class Notification < ApplicationRecord
  ...
  after_create_commit {broadcast_prepend_to 'notification', target: 'notification', partial: 'layouts/notification', locals: {notification: self, current_user: recipient }}
